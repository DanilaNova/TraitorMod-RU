...
language.Tips = {
    ...
    "Вы можете использовать !роль, чтобы получить информацию о вашем текущем статусе роли.",
...
!toggletraitor - переключает возможность игрока стать предателем
...
!revive [клиент] - оживить персонажа данного клиент
